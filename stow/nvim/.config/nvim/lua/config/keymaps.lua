...
-- EasyMotion
keymap("n", "<leader>/", "<Plug>(easymotion-bd-f)", { desc = "EasyMotion: Find char" })
keymap("n", "<leader>?", "<Plug>(easymotion-overwin-f)", { desc = "EasyMotion: Find char overwin" })

-- Search & Selection (FZF-Lua)
keymap("n", "<leader>ff", ":FzfLua files<cr>", { desc = "FZF: Find files" })
keymap("n", "<leader>fb", ":FzfLua buffers<cr>", { desc = "FZF: Find buffers" })
keymap("n", "<leader>fo", ":FzfLua oldfiles<cr>", { desc = "FZF: Old files" })
keymap("n", "<leader>fh", ":FzfLua history<cr>", { desc = "FZF: History" })
keymap("n", "<leader>fr", ":FzfLua resume<cr>", { desc = "FZF: Resume last picker" })
keymap("n", "<leader>fa", ":FzfLua live_grep<cr>", { desc = "FZF: Live grep" })
keymap("n", "<leader>fw", ":FzfLua grep_cword<cr>", { desc = "FZF: Search word under cursor" })
keymap("n", "<leader>fg", ":FzfLua grep_last<cr>", { desc = "FZF: Repeat last grep" })
keymap("n", "<leader>fl", ":FzfLua blines<cr>", { desc = "FZF: Fuzzy search buffer" })
keymap("n", "<leader>fL", ":FzfLua lines<cr>", { desc = "FZF: Fuzzy search all buffers" })
keymap("n", "<leader>fs", ":FzfLua treesitter<cr>", { desc = "FZF: Treesitter symbols" })
keymap("n", "<leader>fS", ":FzfLua lsp_live_workspace_symbols<cr>", { desc = "FZF: Project symbols" })
keymap("n", "<leader>fq", ":FzfLua quickfix<cr>", { desc = "FZF: Quickfix items" })
keymap("n", "<leader>fQ", ":FzfLua quickfix_stack<cr>", { desc = "FZF: Quickfix stack" })
keymap("n", "<leader>fk", ":FzfLua keymaps<cr>", { desc = "FZF: Search keymaps" })
keymap("n", "<leader>f?", ":FzfLua help_tags<cr>", { desc = "FZF: Help tags" })
